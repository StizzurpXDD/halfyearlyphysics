...
slug: "gravitation"
unit: "Gravitation"
description: "Newton's universal law of gravitation, Kepler's laws of planetary motion, acceleration due to gravity & variations with altitude/depth/latitude, gravitational potential & energy, escape velocity, and satellite orbital dynamics."
difficulty: "Core"
derivationsCount: 14
formulasCount: 25
topics:
  ...
  - "Variation with Altitude, Depth & Latitude"
  - "Gravitational Field & Potential"
  - "Gravitational Potential Energy"
  - "Escape Speed & Energetics"
  - "Satellites & Orbital Mechanics"
keyFormulasPreview:
  - "F = G\\frac{m_1 m_2}{r^2}, \\quad g = \\frac{GM}{R^2}"
  - "g_h \\approx g\\left(1 - \\frac{2h}{R}\\right), \\quad g_d = g\\left(1 - \\frac{d}{R}\\right)"
  - "V(r) = -\\frac{GM}{r}, \\quad U(r) = -\\frac{GMm}{r}"
  - "v_e = \\sqrt{2gR} \\approx 11.2\\text{ km/s}"
  - "v_o = \\sqrt{gR} \\approx 8\\text{ km/s}, \\quad v_e = \\sqrt{2}v_o"
accentColor: "indigo"
...
<div class="d3-chart-card" data-chart="grv-kepler" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2.5rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Kepler's Third Law: Period-Radius Coordinate Plot ($T^2$ vs $r^3$)</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Plot: Demonstrates the exact linear proportionality $T^2 = \left(\frac{4\pi^2}{GM_s}\right)r^3$. Hover over the trajectory to inspect planetary orbital coordinates and slope.</p>
</div>
...
<div class="d3-chart-card" data-chart="grv-gravity-variation" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2.5rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Full Radial Profile of Gravitational Acceleration $g(r)$ Inside & Outside Earth</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Plot: Demonstrates the linear increase inside Earth ($g \propto r$) to surface peak $g_0 \approx 9.8\text{ m/s}^2$ at $r = R$, followed by inverse-square hyperbolic decay outside ($g \propto 1/r^2$).</p>
</div>
...
<div class="d3-chart-card" data-chart="grv-potential" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Interactive Gravitational Potential Well: $V(r) = -GM/r$</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Potential Well: Gravitational potential is negative everywhere, rising toward zero as radial separation $r \to \infty$. Hover along the radial distance to inspect the local potential value $V(r)$.</p>
</div>
