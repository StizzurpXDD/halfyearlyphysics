...
unit: "Kinematics"
description: "2D Kinematics, vector algebra, projectile motion (oblique & horizontal), and uniform circular motion."
difficulty: "Core"
derivationsCount: 12
formulasCount: 28
topics:
  ...
  - "Oblique Projectile Trajectory"
  - "Time of Flight, Height & Range"
  - "Complementary Launch Angles"
  - "Horizontal Tower Projection"
  - "Centripetal Acceleration in UCM"
keyFormulasPreview:
...
Motion in a plane (two-dimensional motion) requires vector algebra to analyze position, displacement, velocity, and acceleration simultaneously along two mutually perpendicular axes.
...
<div class="d3-chart-card" data-chart="plane-parallelogram-law" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 600px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Parallelogram Law: Geometric Vector Addition ($\vec{R} = \vec{A} + \vec{B}$)</div>
</div>
...
<div class="d3-chart-card" data-chart="plane-vector-resolution" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 540px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Vector Resolution: Rectangular Components ($A_x\hat{i} + A_y\hat{j}$)</div>
</div>
...
<div class="d3-chart-card" data-chart="plane-projectile-trajectory" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Oblique Projectile Trajectory ($y$ vs $x$)</div>
  <svg viewBox="0 0 540 240" style="width: 100%; max-width: 540px; height: auto; display: block; margin: 0 auto; overflow: visible;">
    ...
    <!-- Launch Vector u -->
    <line x1="40" y1="200" x2="115" y2="105" stroke="#34d399" stroke-width="3" marker-end="url(#arrEmerald)"/>
    ...
    <line x1="250" y1="80" x2="310" y2="80" stroke="#38bdf8" stroke-width="2.5" marker-end="url(#arrCyan)"/>
...
<div class="d3-chart-card" data-chart="plane-complementary-angles" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Complementary Launch Angles ($\theta$ vs $90^\circ - \theta$)</div>
...
<div class="d3-chart-card" data-chart="plane-horizontal-projectile" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 600px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Horizontal Projectile Motion: Cliff Launch, Trajectory & Landing Velocity</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Trajectory: Launch from height $h$ with horizontal speed $u$. Hover along the path to track instantaneous coordinates $(x, y)$, time $t$, and striking velocity $v = \sqrt{v_x^2 + v_y^2}$.</p>
</div>
...
<div class="d3-chart-card" data-chart="plane-circular-motion" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.75rem; font-size: 0.95rem;">Interactive Circular Motion: Inward Centripetal Acceleration & Tangential Velocity</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Diagram: Velocity vector $\vec{v}$ remains tangent to the circular trajectory while centripetal acceleration $\vec{a}_c$ points strictly inward toward center $O$. Hover around the path to rotate the particle and observe real-time kinematics.</p>
</div>

<div style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 480px;">
  <div style="font-weight: 600; color: #a1a1aa; font-size: 0.85rem; margin-bottom: 0.5rem; text-align: center;">Velocity Vector Triangle ($\Delta\vec{v}$ perpendicular to $\vec{v}$)</div>
  <svg viewBox="0 0 200 180" style="width: 100%; max-width: 200px; height: auto; display: block; margin: 0 auto; overflow: visible;">
    <!-- Vectors v1 and v2 starting from vertex -->
