...
unit: "Mechanics"
description: "Work done by constant & variable forces, work-energy theorem, spring potential energy, mechanical energy conservation, vertical circular motion, power, and 1D/2D collisions."
difficulty: "Advanced"
derivationsCount: 10
formulasCount: 29
topics:
  - "Work & Work-Energy Theorem"
  - "Variable Force & Area Integrals"
  - "Spring Potential Energy & Hooke's Law"
  - "Conservation of Mechanical Energy"
  - "Vertical Circular Motion Dynamics"
  - "Power & Machine Efficiency"
  - "Elastic & Inelastic Collisions (1D)"
  - "Glancing 2D Collisions & Bouncing Ball"
keyFormulasPreview:
  - "W = \\int \\vec{F} \\cdot d\\vec{r} = \\Delta K"
  - "U_s = \\frac{1}{2}kx^2, \\quad F = -\\frac{dU}{dx}"
  - "v_L = \\sqrt{5gR}, \\quad T_L - T_H = 6mg"
  - "P = \\vec{F} \\cdot \\vec{v}"
  - "e = \\frac{v_2 - v_1}{u_1 - u_2}, \\quad \\theta_1 + \\theta_2 = 90^\\circ"
accentColor: "amber"
...
<div class="d3-chart-card" data-chart="wep-power-time" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Interactive Power vs. Time Curve: Area Equals Total Energy Delivered</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Power Integral: Shaded area under the $P(t)$ curve represents the total work delivered: $W = \int P(t)\,dt$. Hover along the curve to inspect instantaneous power and accumulated energy.</p>
</div>
...
<div class="d3-chart-card" data-chart="wep-constant-force-work" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 600px;">
  ...
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Diagram: Net work done $W_{\text{net}} = F \cdot s = \Delta K$. Hover across the displacement path to inspect work done, current velocity $v$, and kinetic energy gain.</p>
</div>
...
<div class="d3-chart-card" data-chart="wep-variable-work" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Interactive Variable Force F(x) – Displacement Curve: Area Equals Work Done</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Integral: Total work done equals the definite integral $W = \int_{x_i}^{x_f} F(x)\,dx$. Hover along the displacement axis to inspect the force $F(x)$, differential strip $dW$, and accumulated work.</p>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(290px, 1fr)); gap: 1.5rem; margin: 2.5rem 0;">
<div class="d3-chart-card" data-chart="wep-hooke" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.25rem; backdrop-filter: blur(12px);">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Force-Displacement Graph (Hooke's Law)</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Plot: Work done is represented by the shaded triangular area under the $F_{\text{ext}} = kx$ line: $W = \frac{1}{2}kx_m^2$.</p>
</div>

<div class="d3-chart-card" data-chart="wep-potential" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.25rem; backdrop-filter: blur(12px);">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Potential Energy Well Parabola $U(x)$</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Plot: Symmetric potential well $U(x) = \frac{1}{2}kx^2$ bounded by total mechanical energy $E$ at turning points $\pm A$.</p>
</div>
...
<div class="d3-chart-card" data-chart="wep-falling-energy" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 2.5rem 0; backdrop-filter: blur(12px); max-width: 580px;">
  <div style="font-weight: 600; color: #f4f4f5; margin-bottom: 0.25rem; font-size: 0.95rem;">Energy vs Height Graph for Freely Falling Body</div>
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Plot: Shows the continuous linear trade-off between potential energy $U(y) = mgy$ and kinetic energy $K(y)$, keeping total mechanical energy $E = mgH$ constant with equal energy at $y = H/2$.</p>
</div>
...
<div class="d3-chart-card" data-chart="wep-potential-equilibrium" style="background: rgba(18, 18, 23, 0.7); border: 1px solid rgba(255,255,255,0.08); border-radius: 1.25rem; padding: 1.5rem; margin: 1.5rem 0; backdrop-filter: blur(12px); max-width: 600px;">
  ...
  <p style="font-size: 0.8rem; color: #a1a1aa; margin-top: 0.5rem; line-height: 1.4;">Interactive D3 Analysis: Demonstrates the negative gradient relationship $F(x) = -\frac{dU}{dx}$. Hover along the potential landscape to evaluate local force direction and equilibrium states (stable, unstable, neutral).</p>
</div>
